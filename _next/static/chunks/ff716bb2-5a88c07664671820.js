"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[251],{48683:(e,t,n)=>{n.d(t,{YE:()=>$,bf:()=>v,yr:()=>l});var r=n(48053),i=n(46519),o=n(15768);let{getBroadcastDims:a}=r.C0T;function l(e,t,n){var l,C,T,m;let R,g,w=[];if(e.forEach(e=>{let t=r.ZSL.sizeFromShape(e.shapeInfo.logicalShape);if(e.shapeInfo.isUniform?w.push(`uniform float ${e.name}${t>1?`[${t}]`:""};`):(w.push(`uniform sampler2D ${e.name};`),w.push(`uniform int offset${e.name};`)),n.enableShapeUniforms){let{uniformShape:t}=$(n.packedInputs,e.shapeInfo.logicalShape,e.shapeInfo.texShape);switch(t.length){case 1:w.push(`uniform int ${e.name}Shape;`);break;case 2:w.push(`uniform ivec2 ${e.name}Shape;`);break;case 3:w.push(`uniform ivec3 ${e.name}Shape;`);break;case 4:w.push(`uniform ivec4 ${e.name}Shape;`)}w.push(`uniform ivec2 ${e.name}TexShape;`)}}),n.enableShapeUniforms){switch(t.logicalShape.length){case 1:w.push("uniform int outShape;");break;case 2:w.push("uniform ivec2 outShape;"),w.push("uniform int outShapeStrides;");break;case 3:w.push("uniform ivec3 outShape;"),w.push("uniform ivec2 outShapeStrides;");break;case 4:w.push("uniform ivec4 outShape;"),w.push("uniform ivec3 outShapeStrides;")}w.push("uniform ivec2 outTexShape;")}n.customUniforms&&n.customUniforms.forEach(e=>{w.push(`uniform ${e.type} ${e.name}${e.arrayIndex?`[${e.arrayIndex}]`:""};`)});let y=w.join("\n"),I=e.map(e=>(function(e,t,n=!1,o){let l="";n?l+=function e(t,n){switch(t.shapeInfo.logicalShape.length){case 0:var o=t;let a=o.name,l="get"+a.charAt(0).toUpperCase()+a.slice(1),c=(0,i.B)();return`
    vec4 ${l}() {
...
`}(t,n);case 3:return function(t,n){let i=t.shapeInfo.logicalShape,o=t.name,a="get"+o.charAt(0).toUpperCase()+o.slice(1),l=i[1]*i[2],c=i[2],{newShape:u,keptDims:p}=r.ZSL.squeezeShape(i);if(u.length<i.length){let r=f(t,u);return`
  ...
  `}(e,t):l+=function(e,t){let n,i=e.name,o=i.charAt(0).toUpperCase()+i.slice(1),l="get"+o+"AtOutCoords",c=t.texShape,u=e.shapeInfo.texShape,p=e.shapeInfo.logicalShape.length,x=t.logicalShape.length;if(!e.shapeInfo.isUniform&&p===x&&null==e.shapeInfo.flatOffset&&r.ZSL.arraysEqual(u,c))return`
      float ${l}() {
  ...
  `;case 2:var l=e,c=t,u=n;let p=[Math.ceil(c[0]/2),Math.ceil(c[1]/2)];if(r.ZSL.arraysEqual(l,c))return u?`
  ...
  `;case 2:return l=e,c=t,u=n,r.ZSL.arraysEqual(l,c)?u?`
      ivec2 getOutputCoords() {
...
`}let d=o.UG(["r","c","d"],p);return`
  ...
  `),n.packedInputs&&(O+=x),[O,V,g,y,R,I,n.userCode].join("\n")}let c=`
